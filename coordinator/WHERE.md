...
Generated **2026-08-09 15:31** at commit `ddc182f` by `coordinator\start.bat`. **Never hand-edit it** — it is regenerated and nothing is lost if it is deleted.
...
| **devig** | two recorders running - the main one and a new Champions League/Premier League one on its own database | measure how OFTEN the 97c trade is really available in the last 20 minutes (only 3 sightings so far); the Champions League recorder needs ~2 weeks before it has useful da | 1 CHECK IT BY HAND, 1 FINISHED | **YES** |
...
| **soccer** | the comeback table is BUILT on 56,173 matches 2015-2024; measuring what Kalshi actually charges in those states | the user picks one pocket from the table, then the pre-registered test runs on the held-out 2025-2026 years | none | no |
| **reopen** | nothing running - the first pass over all 342 recorded claims is finished and filed | re-audit after the owning chats answer, and audit the three folders that have no ledger rows once someone ledgers them | none | **YES** |
...
- reopen thirteen threads now, or finish the soccer table first? Both cases are in reopen/REOPENED.md and it is the only thing in there I cannot decide — *that chat said so, in its own words*
...
| Crypto trade-tape download | **FINISHED** | A one-off download of every recorded trade on the 15-minute Bitcoin markets. It was supposed to finish and stop. | Its log ends with '== DONE', so it completed. It last wrote 2 days ago. This is normal and needs nothing. |
...
- `bot-hunt/data/recorder_soccer_eu2.log` — last touched less than a minute ago
- `bot-hunt/data/recorder6.log` — last touched 9 minutes ago
- `bot-hunt/data/recorder_soccer_eu.err` — last touched 16 hours ago
- `bot-hunt/data/recorder_soccer_eu.log` — last touched 16 hours ago
- `bot-hunt/data/recorder5.log` — last touched 34 hours ago
- `bot-hunt/data/pull_btcd.log` — last touched 2 days ago
- `kalshi-market-scan/data/wpull_dch.log` — last touched 2 days ago
- `bot-hunt/data/recorder4.log` — last touched 3 days ago
- …and 11 older ones.
...
|---|---|---|---|
| tennis | 20 hours ago | 2026-08-08 18:56 | tennis-paper-forward/HANDOFF.md |
| mlb | 20 hours ago | 2026-08-08 19:00 | its BRIEF.md section |
| devig | 20 hours ago | 2026-08-08 23:12 | its BRIEF.md section |
| signal | 20 hours ago | 2026-08-08 18:57 | its BRIEF.md section |
| soccer | 12 hours ago | 2026-08-09 04:22 | soccer/HANDOFF.md |
| reopen | 16 hours ago | 2026-08-08 23:21 | reopen/HANDOFF.md |
| coordinator | 19 hours ago | 2026-08-08 19:38 | coordinator/HANDOFF.md |
