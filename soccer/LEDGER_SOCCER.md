...
| **SO047** | **The sample size a settled bet needs is fixed by its price, and it is arithmetic rather than method.** | `GUARDS.md` #28 | derivation + 73 measured matches | spread = 100·√(P(1−P)). Predicted **45.8c** at a 70c price; **measured 41.9c**. To see 1 cent: **10,000 bets at 50c, 8,400 at 70c, 1,164 at 97c** | **SETTLED (arithmetic)** — for the question *"did this make money"*, unpaired. A **paired** design (two arms on the same event) cancels the outcome and escapes it, which is the way out and is in the guard |
| **SO048** | **⚠ The market gives liquidity exactly where measurement is most expensive.** | `GUARDS.md` #24 + #28 | — | at **97c** an edge needs only **47** bets to see 5 cents but **nobody quotes it** (SO041: 29 in 100). At **50c** you can always trade (100 in 100) but need **400** bets for the same 5 cents, and **2,500** for 2 | **SETTLED as a structural tension** — "I can trade it" and "I can measure it" pull in opposite directions. It explains why this folder's answers keep landing on "cannot tell" |
