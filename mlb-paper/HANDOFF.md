...
<!-- COORDINATOR-STATE
doing: answered his take-profit/stop-loss sweep and settled why the lineup bot has never bet; 16 bots, 640 positions settled
left: reach n=130 decisions per bot on closing-line value (~2-3 weeks); measure what a lineup absence is really worth, instead of the 0.15 runs that was assumed
needs: no
-->
